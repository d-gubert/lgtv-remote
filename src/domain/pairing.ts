/**
 * The registration handshake webOS expects. This is the long-standing payload
 * used by every third-party LG remote (it identifies itself as the "LG Remote
 * App" test client); the signature block is checked by the TV, so the contents
 * must be sent verbatim.
 */
export const pairingManifest = {
  forcePairing: false,
  pairingType: "PROMPT",
  manifest: {
    manifestVersion: 1,
